...
public static void performUnion(Set<String> s1, Set<String> s2) { 
        ...
        public static void performDifference(Set<String> s1, Set<String> s2) {     
        	...
        	Set<String> s1Differences1 = new HashSet<>(s1);      
           s1Differences1.removeAll(s2);
          
          	Set<String> s2Differences2 = new HashSet<>(s2);          
          		s2Differences2.removeAll(s1);
          			System.out.println("s1 difference s2: " + s1Differences1);        
          		    System.out.println("s2 difference s1: " + s2Differences2);  
      }
