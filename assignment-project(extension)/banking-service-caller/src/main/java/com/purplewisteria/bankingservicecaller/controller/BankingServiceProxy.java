...
public interface BankingServiceProxy {
	...
	@GetMapping("/banking-service/credit-cards/card/{cardName}")
	public CreditCardDetails retrieveCreditCardDetails(@PathVariable String cardName );
		
	@GetMapping("/banking-service/savings/account/{accountType}")
	...
	@GetMapping("/banking-service/savings/accounts")
